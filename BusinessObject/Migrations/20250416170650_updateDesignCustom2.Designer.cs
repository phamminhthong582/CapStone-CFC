...
namespace BusinessObject.Entities
{
    ...
    [Migration("20250416170650_updateDesignCustom2")]
    partial class updateDesignCustom2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusinessObject.Entities.FailOrder", b =>
                {
                    b.Property<Guid>("FailOrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("(newid())");
                    ...
                    b.HasKey("FailOrderId");

                    b.HasIndex("DeliveryId");

                    b.HasIndex("OrderId");

                    b.ToTable("FailOrder", (string)null);
                });
            ...
            modelBuilder.Entity("BusinessObject.Entities.ProductCustom", b =>
                {
                    ...
                    b.Property<string>("productCustomImage")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BusinessObject.Entities.Notification", b =>
                {
                    b.HasOne("BusinessObject.Entities.Message", "Message")
            ...
            modelBuilder.Entity("BusinessObject.Entities.ProductCustom", b =>
                {
                    b.HasOne("BusinessObject.Entities.Accessory", "Accessory")
