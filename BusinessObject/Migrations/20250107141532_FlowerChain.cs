...
{
    /// <inheritdoc />
    public partial class FlowerChain : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    FlowerCustomId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.FlowerCustomId,
                        principalTable: "FlowerCustom",
                        principalColumn: "FlowerCustomId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCustom_FlowerCustomId",
                table: "ProductCustom",
                column: "FlowerCustomId");
